      ...
      <main className="public-main public-home">
        ...
        <section className="public-section">
          ...
          <div className="public-door-grid">
            ...
            <button type="button" className="public-door-card" onClick={() => onEnterAtlas?.("desafio")}><Swords size={22} /><strong>Desafío</strong><span>Pon a prueba lo que sabes con la propia base genealógica.</span></button>
