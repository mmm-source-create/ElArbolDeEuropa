...
for(const [nombre,entidad] of Object.entries(TERRITORIOS)) {
 ...
 const meta={nombre,slug:slugPublico(nombre),...entidad,...historia,editorial:Boolean(historia.resumen),fuentes:FUENTES_TERRITORIOS[nombre]||[],gobiernos,dinastias,relacionados,
